...
public class Excel {
    ...
    public void test1() throws IOException {
        ...
        FileOutputStream out = new FileOutputStream("src/main/resources/excelDemo/1.xls");
        wb.write(out);
        //流的关闭
        out.close();
    ...
    public void test2() throws IOException {
        ...
        //创建流并将wb输出
        FileOutputStream out = new FileOutputStream("src/main/resources/excelDemo/2.xls");
        wb.write(out);
        //流的关闭
        out.close();
    ...
    public void test3() throws IOException {
        ...
        //创建流并将wb输出
        FileOutputStream out = new FileOutputStream("src/main/resources/excelDemo/3.xls");
        wb.write(out);
        //流的关闭
        out.close();
    ...
    public void test4() throws IOException {
        ...
        //创建流并将wb输出
        FileOutputStream out = new FileOutputStream("src/main/resources/excelDemo/4.xls");
        wb.write(out);
        //流的关闭
        out.close();
    ...
    public void readExcelTest() throws Exception {
        //读取文件的位置
        String path = "src/main/resources/excelDemo/4.xls";
        //获取文件输入流
        FileInputStream fileInputStream = new FileInputStream(path);
        //通过文件流创建（获取）工作簿,excel中的操作，Java基本都能实现，这里的新建的对象注意与excel版本对应
        Workbook workbook = new XSSFWorkbook(fileInputStream);//HSSFWorkbook读取97-2003格式 ，XSSFWorkbook读取2007-2013格式
...
//        Sheet sheet = workbook.getSheet("sheet01");//也可以使用sheet的名称去获取
        List<Object> list = new ArrayList<>();
        //获取行数
        int rows = sheet.getPhysicalNumberOfRows();
        System.out.println("获取行数"+rows);
        for (int i = 0; i < rows; i++) {//i=1表示是从第二行读取
            //获取列数
    ...
    public void demo() throws IOException {
        ...
        // 创建流并将wb输出
        FileOutputStream out = new FileOutputStream("src/main/resources/excelDemo/应缴金额.xls");
        wb.write(out);
        // 流的关闭
        out.close();
        System.out.printf("单元格创建其他值的示例成功");
